...
export default function PaymentDialog(props: Props) {
    ...
    const PaymentFormSchema = z.object({
        ...
        description: z
            ...
            .max(
                500,
                t("form.payment.description.validation.max", { max: 500 }),
            )
            .optional()
            .or(z.literal("")),
    });
        ...
        <Form {...form}>
            ...
            >
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                            ...
                                            <InputGroupAddon align="inline-end">
                                                <Tooltip disableHoverablePopup>
                                                    ...
                                                    <TooltipContent>
                                                        <p>
                                                            {t(
                                                                "form.payment.exchange_rate.set.tooltip",
                                                            )}
                                                        </p>
                                                    </TooltipContent>
                                                </Tooltip>
                                ...
                                <FormDescription>
                                    {t(
                                        "form.payment.exchange_rate.description",
                                    )}
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                ...
                <div className="flex justify-end gap-2 col-span-2">
                    ...
                    <Button type="submit">
                        {payment
                            ? t("dialog.payment.update")
                            : t("dialog.payment.add")}
                    </Button>
                </div>
            </form>
        </Form>
