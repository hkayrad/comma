                        ...
                        case "check":
                            return (
                                <Badge
                                    ...
                                    onClick={() =>
                                        copyToClipboard(t("vars.check"), t)
                                    }
                                >
                                    {t("vars.check")}
                                </Badge>
                            ...
                            <Dialog>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        <DialogTitle>
                                            {t(
                                                "payment.table.column.actions.delete.title",
                                            )}
                                        </DialogTitle>
                                        <DialogDescription>
                                            {t(
                                                "payment.table.column.actions.delete.description",
                                            )}
                                        </DialogDescription>
                                    </DialogHeader>
                                    <DialogFooter>
                                        ...
                                        >
                                            {t(
                                                "payment.table.column.actions.delete.confirm",
                                            )}
                                        </Button>
                                    </DialogFooter>
                                </DialogContent>
