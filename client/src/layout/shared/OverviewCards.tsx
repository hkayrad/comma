...
export default function OverviewCards(props: Props) {
    ...
    const [receivableTotals, setReceivableTotals] = useState<Totals | null>(
        null,
    );
    ...
    useEffect(() => {
        if (type === "receivable") {
            if (receivableTotals) {
                setFormattedTotals({
                    total_debts: Number(
                        receivableTotals.total_debts || 0,
            ...
            <Card className="grow w-48 shadow-xs">
                <CardHeader>
                    ...
                    <CardTitle
                        ...
                        onClick={() =>
                            copyToClipboard(formattedTotals.total_debts, t)
                        }
                    >
                        {isLoading ? (
            ...
            <Card className="grow w-48 shadow-xs">
                <CardHeader>
                    ...
                    <CardTitle
                        ...
                        onClick={() =>
                            copyToClipboard(formattedTotals.total_payments, t)
                        }
                    >
                        {isLoading ? (
                            <Skeleton className="h-7 w-full" />
            ...
            <Card className="grow w-48 shadow-xs">
                <CardHeader>
                    ...
                    <CardTitle
                        ...
                        onClick={() =>
                            copyToClipboard(formattedTotals.remaining_debt, t)
                        }
                    >
                        {isLoading ? (
                            <Skeleton className="h-7 w-full" />
