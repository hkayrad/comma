        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Şirket veya birey adı.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Müşteri türünü seçin.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Müşterinin vergi dairesi.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Müşterinin MERSİS numarası.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Müşterinin telefon numarası.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Müşterinin e-posta adresi.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Müşterinin adresi.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
