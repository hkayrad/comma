        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-2 gap-8">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Şirket Adı <span className="text-red-500">*</span></FormLabel>
                            <FormControl>
                                <InputGroup>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="flex gap-1">Hesap Türü <span className="text-red-500">*</span></FormLabel>
                            <FormControl>
