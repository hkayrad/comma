...
export default function InformationForm() {
    const [companyDetails, setCompanyDetails] = useState<CompanyDto | null>(
        null,
    );
    ...
    const CompanyFormSchema = z.object({
        name: z
            ...
            .max(
                255,
                t("form.company.name.validation.max", { charCount: 255 }),
            ),
        ...
        email: z
            ...
            .max(
                255,
                t("form.company.email.validation.max", { charCount: 255 }),
            )
            .optional()
            .or(z.literal("")),
        tax_number: z
            ...
            .min(
                5,
                t("form.company.tax_number.validation.min", { charCount: 5 }),
            )
            .max(
                11,
                t("form.company.tax_number.validation.max", { charCount: 11 }),
            )
            .optional()
            .or(z.literal("")),
        tax_office: z
            ...
            .min(
                2,
                t("form.company.tax_office.validation.min", { charCount: 2 }),
            )
            .max(
                100,
        ...
        mersis_no: z
            ...
            .min(
                16,
                t("form.company.mersis_no.validation.min", { charCount: 16 }),
            )
            .max(
                16,
                t("form.company.mersis_no.validation.max", { charCount: 16 }),
            )
            .optional()
            .or(z.literal("")),
        address: z
            ...
            .max(
                500,
                t("form.company.address.validation.max", { charCount: 500 }),
            )
            .optional()
            .or(z.literal("")),
    });
                            ...
                            <FormDescription>
                                {t("form.company.tax_number.description", {
                                    tax_number_text: form.watch("is_company")
                                        ? t(
                                              "form.company.tax_number",
                                          ).toLowerCase()
                                        : t(
                                              "form.company.tax_number_alternative",
                                          ),
                                })}
                            </FormDescription>
                            <FormMessage />
