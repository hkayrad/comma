        ...
        () =>
            z.object({
                ...
                tax_number: z
                    .string({
                        message: t(
                            "form.company.tax_number.validation.invalid",
                        ),
                    })
                    .min(
                        5,
                ...
                tax_office: z
                    .string({
                        message: t(
                            "form.company.tax_office.validation.invalid",
                        ),
                    })
                    .min(
                        2,
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        {t(
                                            "form.company.tax_office.description",
                                        )}
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        {t(
                                            "form.company.mersis_no.description",
                                        )}
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
