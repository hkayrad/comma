...
export default function DebtDialog(props: Props) {
    ...
    const DebtFormSchema = z.object({
        ...
        amount: z
            .number({ error: t("form.debt.amount.validation.invalid") })
            .min(
                0.01,
        ...
        invoice_no: z
            ...
            .max(
                100,
                t("form.debt.invoice_no.validation.max", { charCount: 100 }),
            )
            .optional()
            .or(z.literal("")),
        description: z
            ...
            .max(
                500,
                t("form.debt.description.validation.max", { charCount: 500 }),
            )
            .optional()
            .or(z.literal("")),
    });
                                            ...
                                            <InputGroupAddon align="inline-end">
                                                ...
                                                >
                                                    ...
                                                    <TooltipContent>
                                                        <p>
                                                            {t(
                                                                "form.debt.exchange_rate.set.tooltip",
                                                            )}
                                                        </p>
                                                    </TooltipContent>
                                                </Tooltip>
