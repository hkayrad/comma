...
function normalizeSelected(selected: unknown): unknown {
  ...
  if (Array.isArray(selected)) {
    return selected.map((d) => (d instanceof Date ? normalizeToNoon(d) : d));
  }
...
function Calendar({
  ...
  const handleSelect = React.useMemo(() => {
    ...
    return (
      ...
      originalOnSelect(normalizedSelected, normalizedTriggerDate, modifiers, e);
    };
  }, [originalOnSelect]);
    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString(restProps.lang, { month: "short" }),
        ...formatters,
      }}
      classNames={{
