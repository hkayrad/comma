    ...
    return (
        ...
        >
            ...
            <TooltipArrowPrimitive
                className="fill-primary size-3 data-[side='bottom']:-translate-y-px data-[side='right']:-translate-y-px data-[side='left']:-translate-y-px data-[side='top']:-translate-y-px"
                tipRadius={2}
            />
        </TooltipContentPrimitive>
    );
