...
router.get("/customers", async (req: Request, res: Response) => {
	...
	Logger.debug("[PayableCustomersController] Get all customers request", { companyId, page, limit, sorting, filters });

	try {
		const response = await PayableCustomersService.GetAll(companyId, page, limit, sorting, filters);
