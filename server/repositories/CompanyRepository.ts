...
export class CompanyRepository {
	...
	static async create(companyData: any, transaction?: Transaction) {
		return await Companies.create(companyData, { transaction });
	}

	static async update(id: UUID, updateData: any, transaction?: Transaction) {
		return await Companies.update(updateData, { where: { id }, transaction });
	}
